...
*/
    ...
    var kkpager = {
        ...
        generPageHtml: function () {
            ...
            var j = "", d = "";
            if (this.hasPrv) {
                j = '<a href="' + this.getLink(this.prv) + '" title="' + this.lang.prePageText + '">' + this.lang.prePageText + "</a>"
            } else {
                j = '<span class="disabled">' + this.lang.prePageText + "</span>"
            }
            if (this.hasNext) {
                d = '<a href="' + this.getLink(this.next) + '" title="' + this.lang.nextPageText + '">' + this.lang.nextPageText + "</a>"
            } else {
            ...
            var g = "";
            if (this.isGoPage) {
                g = "&nbsp;" + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '"><input type="button" id="' + this.gopageButtonId + '" onclick="kkpager.gopage()" value="' + this.lang.gopageButtonOkText + '" /><input type="text" id="' + this.gopageTextboxId + '" onfocus="kkpager.focus_gopage()"     onblur="kkpager.blur_gopage()" value="' + this.next + '" /></span>' + this.lang.gopageAfterText
            }
            if (this.total <= 8) {
                for (var e = 1; e <= this.total; e++) {
                    if (this.pno == e) {
                        ...
                        h += '<a href="' + this.getLink(e) + '" title="' + this.lang.buttonTipBeforeText + e + this.lang.buttonTipAfterText + '">' + e + "</a>"
                    }
                }
            } else {
                if (this.pno <= 5) {
                    ...
                    h += '<a href="' + this.getLink(1) + '" title="' + this.lang.buttonTipBeforeText + "1" + this.lang.buttonTipAfterText + '">1</a>';
                    h += '<a href="' + this.getLink(2) + '" title="' + this.lang.buttonTipBeforeText + "2" + this.lang.buttonTipAfterText + '">2</a>';
                    h += a;
                    var b = this.pno - 2;
                    var c = this.pno + 2;
                    if (c > this.total) {

...
define(function(require,exports,module){
   ...
   /*  $("body").delegate(".js_operate_item","click",function(){
        ...
        submitHandler: function(form) {
            ...
            var options = {
                ...
                success: function (data1) {
                    if (data1.isSuccess) {
                        $(".updateSuccess").css({"left": "50%", "top": "50%", "opacity": "1"}).fadeIn();

                        setTimeout(function () {
                            $(".updateSuccess").animate({
                                "opacity": "0"
                            }, 500, function () {
                                $(".updateSuccess").hide();
                            });
                        ...
                        $(".updateFail").css({"left": "50%", "top": "50%", "opacity": "1"}).fadeIn();
                        setTimeout(function () {
                            $(".updateFail").animate({
                                "opacity": "0"
                            }, 500, function () {

requirejs.config({
    ...
    paths: {
        ...
        kindeditor:"jslib/kindeditor/kindeditor-all-min",
        photoClip:"jslib/jquery.photoClip1.8.0",
        hammer:"jslib/hammer.min",
        iscrollzoom:"jslib/iscroll-zoom",
        lrzallbundle:"jslib/lrz.all.bundle"
    }
});